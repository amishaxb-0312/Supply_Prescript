  ...
  return (
    <div className="relative mx-auto h-[430px] w-full max-w-[680px] sm:h-[470px]">
      ...
      <div className="absolute right-0 top-[92px] z-20 w-[250px] rounded-2xl border border-white/80 bg-white p-4 shadow-2xl shadow-blue-900/10 dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/30 sm:right-[20px] sm:top-[105px] sm:w-[280px] sm:p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="ml-auto text-[9px] font-bold text-slate-800 dark:text-slate-200">
              77%
            </span>
          </div>
      ...
      <div className="absolute bottom-[8px] left-0 z-30 hidden items-center gap-2 rounded-xl border border-white bg-white px-3 py-2.5 shadow-xl shadow-blue-900/10 dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/30 sm:flex sm:px-4 sm:py-3">
        ...
        <div>
          <p className="text-[8px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400">
            Status
          </p>
...
function Home() {
  return (
    <div className="min-h-screen overflow-hidden bg-white text-slate-900 dark:bg-[#0b1120] dark:text-slate-100">
      ...
      <header className="border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-[#0b1120]">
        <div className="mx-auto flex h-[76px] max-w-[1400px] items-center justify-between px-5 sm:px-8 lg:px-12">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[16px] font-bold tracking-tight text-slate-950 dark:text-white sm:text-[17px]">
                SupplyPrescript
              </p>
          ...
          <nav className="hidden items-center gap-8 sm:flex">
            ...
            <Link
              to="/dashboard"
              className="py-2 text-xs font-bold text-slate-700 transition hover:text-blue-700 dark:text-slate-300 dark:hover:text-blue-300"
            >
              Dashboard
            </Link>
          </nav>
      ...
      <section
        id="home"
        className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/70 to-sky-50 dark:from-[#0b1120] dark:via-[#101a2e] dark:to-[#0d1b2e]"
      >
        <div className="absolute left-[-120px] top-[-100px] h-[300px] w-[300px] rounded-full bg-blue-100/50 blur-3xl dark:bg-blue-900/20" />
        ...
        <div className="relative mx-auto grid max-w-[1400px] items-center gap-2 px-5 py-10 sm:px-8 sm:py-14 lg:grid-cols-[0.9fr_1.1fr] lg:px-12 lg:py-12">
          ...
          <div className="relative z-10 max-w-[610px]">
            ...
            <p className="mt-6 max-w-[530px] text-sm font-medium leading-7 text-slate-600 dark:text-slate-300 sm:text-[15px]">
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg hover:shadow-slate-900/5 dark:border-slate-800 dark:bg-[#111827] dark:hover:border-slate-700 dark:hover:shadow-black/20"
              >
                <div
                ...
                <p className="mt-2 text-[10px] font-medium leading-5 text-slate-600 dark:text-slate-400">
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
            <div className="max-w-[430px]">
              <p className="text-[9px] font-bold uppercase tracking-[0.16em] text-blue-700 dark:text-blue-300">
                How It Works
              </p>
              ...
              <div className="relative grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
                {workflow.map((step) => (
                  ...
                  >
                    ...
                    <p className="mt-4 text-xs font-bold text-slate-950 dark:text-white">
                      {step.number}. {step.title}
                    </p>

                    <p className="mx-auto mt-2 max-w-[150px] text-[9px] font-medium leading-5 text-slate-600 dark:text-slate-400">
                      {step.description}
                    </p>
                  </div>
                ))}
